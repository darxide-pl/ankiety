	...
	<div class="panel panel-default">
		...
		<div class="table-responsive">
			...
			<tr>
				...
				<td><?php echo $o->get('plugin') ?></td>
				<td>
					<?php if ($this->auth->checkRight('admin|programers')): ?>
					<a href="<?php echo $this->link->Build(array($this->name,$this->view,'id'=>$o->get('id'),'page_action' => f_eas('Orders_Payments|remove')))?>"
			...
			<?php endforeach; else: ?>
				<tr><td colspan="9999">Nie posiadasz jeszcze żadnej formy płatności lub wybrałeś zbyt szczegółowe filtry wyszukiwania. Skorzystaj z przycisku Dodaj po prawej stronie.</td></tr>
			<?php endif; ?>
			</tbody>
			</table>
